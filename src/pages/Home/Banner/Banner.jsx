        ...
        <div className="relative text-center mb-20">
            ...
            <div className='mx-auto lg:w-3/4 absolute inset-0 flex flex-col items-center justify-center text-center text-gray-100'>
                ...
                <div className='flex gap-7'>
                    <Link to="/registration"><button className='btn bg-yellow-300 border-0'>Join as a Donor</button></Link>
                    <Link><button className='btn bg-orange-600 text-white border-0'>Search Donors</button></Link>
                </div>
